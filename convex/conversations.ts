...
// Đuổi người dùng khỏi cuộc trò chuyện
export const kickUser = mutation({
	...
	handler: async (ctx, args) => {
		...
		if (conversation.admin !== identity.tokenIdentifier) {
			throw new ConvexError("Only admin can kick users from the conversation");
		}
