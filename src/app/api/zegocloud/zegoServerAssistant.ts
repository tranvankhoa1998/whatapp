...
function aesEncrypt(plainText: string, key: string, iv: string): ArrayBuffer {
	...
	var arr_c = new Uint8Array(encrypted)
	var arr_f = new Uint8Array(final)
	const out = Buffer.concat([arr_c, arr_f]);
...
export function generateToken04(
	...
	var u8_iv = new TextEncoder().encode(iv)
	var u8_enb = new Uint8Array(encryptBuf)
